...
of a language, specifically the flavor of that language's union types.

`RemoteData` is a pattern for modeling data generated by a REST request.
The "UI Antipattern" is another approach to modeling that kind of data.
